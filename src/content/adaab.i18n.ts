...
export const ADAAB_I18N: AdaabTr[] = [
  ...
  { en: 'Maintain kindness after their death — du’a, charity,it fo and keeping ties with their friends.', ur: 'ان کی وفات کے بعد بھی حسن سلوک جاری رکھیں — دعا، صدقہ، اور ان کے دوستوں سے تعلق نبھانا۔', roman: 'unki wafat ke baad bhi husn-e-sulook jari rakhein — dua, sadqa, aur unke doston se taalluq nibhana.' },
