...
export const ZIKR: Zikr[] = [
  ...
  {
    slug: 'tasbih-fatima',
    title: 'Tasbih-e-Fatima (after salah)',
    arabic: 'سُبْحَانَ اللهِ ×٣٣، الْحَمْدُ لِلّهِ ×٣٣، اللهُ أَكْبَرُ ×٣٤',
    translit: 'SubhanAllah ×33, Alhamdulillah ×33, Allahu Akbar ×34',
    meaning:
      'After every salah: Glory be to Allah 33×, all praise to Allah 33×, Allah is the Greatest 34× — total 100.',
    target: 100,
    ref: 'Bukhari & Muslim — Abu Hurayrah: Tasbih-e-Fatima after every salah (33/33/34).',
  },
